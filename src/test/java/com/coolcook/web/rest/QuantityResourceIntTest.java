...
public class QuantityResourceIntTest {
    ...
    public void setup() {
        ...
        QuantityResource quantityResource = new QuantityResource(quantityRepository, quantityMapper, quantitySearchRepository);
    ...
    public void createQuantity() throws Exception {
        ...
        assertThat(quantityEs).isEqualToComparingFieldByField(testQuantity);
    }
