...
public class IngredientQtyMappingResourceIntTest {
    ...
    @Autowired
    private IngredientQtyMappingSearchRepository ingredientQtyMappingSearchRepository;
    ...
    public void setup() {
        ...
        IngredientQtyMappingResource ingredientQtyMappingResource = new IngredientQtyMappingResource(ingredientQtyMappingRepository, ingredientQtyMappingMapper, ingredientQtyMappingSearchRepository);
    ...
    public void initTest() {
        ingredientQtyMappingSearchRepository.deleteAll();
    ...
    public void createIngredientQtyMapping() throws Exception {
        ...
        // Validate the IngredientQtyMapping in Elasticsearch
        IngredientQtyMapping ingredientQtyMappingEs = ingredientQtyMappingSearchRepository.findOne(testIngredientQtyMapping.getId());
        assertThat(ingredientQtyMappingEs).isEqualToComparingFieldByField(testIngredientQtyMapping);
    }
    ...
    public void deleteIngredientQtyMapping() throws Exception {
        ...
        boolean ingredientQtyMappingExistsInEs = ingredientQtyMappingSearchRepository.exists(ingredientQtyMapping.getId());
        assertThat(ingredientQtyMappingExistsInEs).isFalse();
    ...
    @Test
    @Transactional
    public void searchIngredientQtyMapping() throws Exception {
        // Initialize the database
        ingredientQtyMappingRepository.saveAndFlush(ingredientQtyMapping);
        ingredientQtyMappingSearchRepository.save(ingredientQtyMapping);

        // Search the ingredientQtyMapping
        restIngredientQtyMappingMockMvc.perform(get("/api/_search/ingredient-qty-mappings?query=id:" + ingredientQtyMapping.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(ingredientQtyMapping.getId().intValue())));
    }
